  ...
  getTexts(lang: Language, type: string): string {
    const texts: TranslatedTexts = {
      ...
      es: {
        title: 'Contacto',
        description:
          'Estaré encantado de recibir tu mensaje. Completa el formulario y me pondré en contacto contigo a la brevedad.',
      ...
      pt: {
        title: 'Contato',
        description:
          'Ficarei feliz em receber sua mensagem. Preencha o formulário abaixo e entrarei em contato o mais rápido possível.',
